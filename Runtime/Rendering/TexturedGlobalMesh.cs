...
#region METHODS
        ...
        {
            // Load the scene representation.
            Debug.Log("LoadProcessedTextureMapsCoroutine");

            yield return StartCoroutine(PMGlobalTextureMap.LoadProcessedTextureMapsCoroutine());
            Debug.Log("LoadProcessedGlobalMeshCoroutine");
