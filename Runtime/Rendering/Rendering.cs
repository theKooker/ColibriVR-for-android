...
#region METHODS
        ...
        private IEnumerator LaunchRenderingCoroutine()
        {
            ...
            Debug.Log("XX:yield return StartCoroutine(selectedBlendingMethod.InitializeRenderingMethodCoroutine());");
#if UNITY_EDITOR
            ...
            Debug.Log("XX:GeneralToolkit.UnloadAssetBundleInMemory(false);;");
