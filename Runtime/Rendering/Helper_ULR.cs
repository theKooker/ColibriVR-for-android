...
#region METHODS
        ...
        {
            Debug.Log("ResetBlendingMaterial");
            ...
            if(_optimizeForHighFramerates){
                ...
                Debug.Log("_optimizeForHighFramerates");
                Debug.Log(GeneralToolkit.shaderRenderingULR == null);

            }
            else {
                Debug.Log("NOT _optimizeForHighFramerates");
                Debug.Log(GeneralToolkit.shaderRenderingULRPerFragment == null);
